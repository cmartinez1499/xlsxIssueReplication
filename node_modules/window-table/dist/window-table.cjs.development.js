...
var useMemo = React.useMemo,
    useReducer = React.useReducer; // Define the initial state of dimensions
...
var FixedSizeList = ReactWindow.FixedSizeList,
    VariableSizeList = ReactWindow.VariableSizeList,
    areEqual = ReactWindow.areEqual;
...
var RowCells = function RowCells(_ref) {
  ...
  return React.createElement(React.Fragment, null, columns.map(function (column, i) {
    var key = column.key,
        width = column.width,
...
var WindowTable = /*#__PURE__*/React.forwardRef(function (_ref5, ref) {
  var columns = _ref5.columns,
      ...
      _ref5$sampleRowIndex = _ref5.sampleRowIndex,
      sampleRowIndex = _ref5$sampleRowIndex === void 0 ? 0 : _ref5$sampleRowIndex,
      sampleRow = _ref5.sampleRow,
      ...
      _ref5$headerCellInner = _ref5.headerCellInnerElementType,
      headerCellInnerElementType = _ref5$headerCellInner === void 0 ? 'div' : _ref5$headerCellInner,
      _ref5$tableCellInnerE = _ref5.tableCellInnerElementType,
      tableCellInnerElementType = _ref5$tableCellInnerE === void 0 ? 'div' : _ref5$tableCellInnerE,
      tableOuterRef = _ref5.tableOuterRef,
      tableOuterElementType = _ref5.tableOuterElementType,
      rest = _objectWithoutPropertiesLoose(_ref5, ["columns", "data", "rowHeight", "height", "width", "overscanCount", "disableHeader", "style", "Cell", "HeaderCell", "Table", "Header", "HeaderRow", "Row", "Body", "sampleRowIndex", "sampleRow", "className", "rowClassName", "classNamePrefix", "debounceWait", "headerCellInnerElementType", "tableCellInnerElementType", "tableOuterRef", "tableOuterElementType"]);

  var measurerRowRef = React.useRef(null);
  var tableClassName = classNamePrefix + "table " + className;
  var List = rowHeight && typeof rowHeight === 'function' ? VariableSizeList : FixedSizeList;
  ...
  var _ref7 = disableHeader ? [0] : dimensions.header,
      headerHeight = _ref7[0];

  var _dimensions$row = dimensions.row,
      sampleRowHeight = _dimensions$row[0];
  var bodyHeight = (height || tableHeight) - headerHeight - 2; // 2px less to avoid possible unnecessary scrollbars
  ...
  React.createElement(Table, {
    ...
    value: tblCtx
  }, React.createElement(HeaderRowRenderer, {
    Header: Header,
    HeaderRow: HeaderRow,
    HeaderCell: HeaderCell
  }, React.createElement(Measurer, {
    measure: measure,
    entity: "header",
    ...
    value: tblCtx
  }, React.createElement("div", null, !disableHeader && tableWidth > 0 && React.createElement(Table, {
    style: {
      width: effectiveWidth + "px",
      marginBottom: 0
    },
    ...
    HeaderRow: HeaderRow,
    HeaderCell: HeaderCell
  })), !!data.length && React.createElement(List, {
    ref: ref,
    height: bodyHeight,
...
var getTHead = function getTHead(headerClassName) {
  ...
  var THead = function THead(props) {
    return React.createElement("thead", Object.assign({}, props, {
...
function Html5Table(_ref) {
  ...
  return React.createElement(WindowTable$1, Object.assign({
    Cell: "td",
    HeaderCell: "th",
...
function useDebouncedState(initialState, wait) {
  ...
  var setDebouncedState = useMemo$2(function () {
...
exports.Html5Table = Html5Table;
exports.WindowTable = WindowTable$1;
exports.createFilter = createFilter;
exports.default = WindowTable$1;
exports.useDebouncedState = useDebouncedState;
exports.useFilter = useFilter;
//# sourceMappingURL=window-table.cjs.development.js.map
