import { createElement, PureComponent, useReducer as useReducer$1, useMemo as useMemo$3, memo as memo$1, forwardRef, useRef, Fragment, useContext as useContext$1, createContext as createContext$1, useState as useState$1 } from 'react';
import { FixedSizeList as FixedSizeList$1, VariableSizeList as VariableSizeList$1, areEqual as areEqual$1 } from 'react-window';
...
var FixedSizeList = FixedSizeList$1,
    VariableSizeList = VariableSizeList$1,
    areEqual = areEqual$1;
...
var WindowTable = /*#__PURE__*/forwardRef(function (_ref5, ref) {
  ...
  createElement(Table, {
    ...
    className: tableClassName
  }, createElement(TableContext.Provider, {
    value: tblCtx
    ...
    HeaderRow: HeaderRow,
    HeaderCell: HeaderCell
  })), !!data.length && createElement(List, {
    ref: ref,
    height: bodyHeight,
